...
public class AuthenticationController {
    ...
    public ResponseEntity<Void> confirmEmail(@RequestParam @NotBlank String token) {
    ...
    public ResponseEntity<Void> resendConfirmEmail(@RequestParam @NotBlank String email) {
